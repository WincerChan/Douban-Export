defmodule DoubanShowTest do
    ...
    test "test concat url by type" do
        assert DoubanShow.concat_url_by_type("book") == "https://book.douban.com/people/93562087/collect"
        assert DoubanShow.concat_url_by_type("movie") == "https://movie.douban.com/people/93562087/collect"
    end
