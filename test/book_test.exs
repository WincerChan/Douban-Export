defmodule BookTest do
                   ...
                   {"a",
                    ...
                    [
                      {"img",
                       [
                         {"class", ""},
                         {"src", "https://img3.doubanio.com/view/subject/m/public/s28857893.jpg"},
                         {"width", "90"}
                       ], []}
                    ]}
                 ]},
                   ...
                   {"h2", [{"class", ""}],
                    [
                      {"a",
                       ...
                       [
                         "\n\n    暴力\n\n\n    \n      ",
                         {"span", [{"style", "font-size:12px;"}], [" : 一种微观社会学理论 "]}
                       ]}
                    ]},
                   {"div", [{"class", "pub"}],
                    [
  ...
  test "test concat_url" do
    assert DoubanShow.Book.concat_url(0) ==
             "https://book.douban.com/people/#{@douban_id}/collect?start=0"
  end
end
