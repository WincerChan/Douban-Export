defmodule MovieTest do
  ...
  test "test movie cover" do
    assert DoubanShow.cover(@movie_item) == "https://img3.doubanio.com/view/photo/s_ratio_poster/public/p642667992.jpg"
  end
  ...
  test "test concat_url" do
    assert DoubanShow.Movie.concat_url(0) == "https://movie.douban.com/people/#{@douban_id}/collect?start=0"
  end
end
